...
Deno.test('nu / arch / add', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/add/firefox?sysOsPlat=linux&sysOsId=arch'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / arch / find', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/find/firefox?sysOsPlat=linux&sysOsId=arch'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / arch / list', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/list?sysOsPlat=linux&sysOsId=arch'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / arch / out', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/out?sysOsPlat=linux&sysOsId=arch'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / arch / rem', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/rem/firefox?sysOsPlat=linux&sysOsId=arch'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / arch / sync', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/sync?sysOsPlat=linux&sysOsId=arch'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / arch / tidy', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/tidy?sysOsPlat=linux&sysOsId=arch'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
...
Deno.test('nu / ubuntu / add', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/add/firefox?sysOsPlat=linux&sysOsId=ubuntu'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / ubuntu / find', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/find/firefox?sysOsPlat=linux&sysOsId=ubuntu'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / ubuntu / list', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/list?sysOsPlat=linux&sysOsId=ubuntu'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / ubuntu / out', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/out?sysOsPlat=linux&sysOsId=ubuntu'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / ubuntu / rem', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/rem/firefox?sysOsPlat=linux&sysOsId=ubuntu'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / ubuntu / sync', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/sync?sysOsPlat=linux&sysOsId=ubuntu'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / ubuntu / tidy', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/tidy?sysOsPlat=linux&sysOsId=ubuntu'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
...
Deno.test('nu / rocky / add', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/add/firefox?sysOsPlat=linux&sysOsId=rocky'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / rocky / find', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/find/firefox?sysOsPlat=linux&sysOsId=rocky'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / rocky / list', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/list?sysOsPlat=linux&sysOsId=rocky'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / rocky / out', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/out?sysOsPlat=linux&sysOsId=rocky'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / rocky / rem', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/rem/firefox?sysOsPlat=linux&sysOsId=rocky'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / rocky / sync', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/sync?sysOsPlat=linux&sysOsId=rocky'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / rocky / tidy', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/tidy?sysOsPlat=linux&sysOsId=rocky'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
...
Deno.test('nu / suse / add', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/add/firefox?sysOsPlat=linux&sysOsId=suse'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / suse / find', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/find/firefox?sysOsPlat=linux&sysOsId=suse'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / suse / list', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/list?sysOsPlat=linux&sysOsId=suse'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / suse / out', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/out?sysOsPlat=linux&sysOsId=suse'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / suse / rem', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/rem/firefox?sysOsPlat=linux&sysOsId=suse'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / suse / sync', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/sync?sysOsPlat=linux&sysOsId=suse'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
Deno.test('nu / suse / tidy', async (t) => {
  const body = await (await runSrv(req('/sh/nu/pack/tidy?sysOsPlat=linux&sysOsId=suse'))).text()
  await assertSnapshot(t, body)
  await checkSyntax('nu', body)
})
